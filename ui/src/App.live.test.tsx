...
const fullRun: WFEvent[] = [
  evt({
    ...
    payload: { workflow: 'demo', version: '1.0.0' },
  }),
  ...
  evt({
    ...
    nodeId: 'a',
    payload: { hash: 'h1', type: 'json' },
  }),
  evt({
    type: 'WorkerFinished',
    nodeId: 'a',
    payload: { costUsd: 0.02, tokens: 10 },
  }),
  ...
  evt({
    type: 'ArtifactCreated',
    nodeId: 'b',
    payload: { hash: 'h2', type: 'test-result' },
  }),
  evt({
    type: 'WorkerFinished',
    nodeId: 'b',
    payload: { costUsd: 0, tokens: 0 },
  }),
...
describe('live execution renders end to end', () => {
  ...
  it('renders node status, running cost, and logs from a folded run', () => {
    ...
    expect(
      screen
        .getAllByText('ExecutionFinished')
    ...
    act(() => {
      const events: WFEvent[] = [
        ...
        evt({
          type: 'CacheHit',
          nodeId: 'a',
          payload: { key: 'k', savedCostUsd: 0.05, savedTokens: 100 },
        }),
        evt({
          type: 'ArtifactCreated',
          nodeId: 'a',
